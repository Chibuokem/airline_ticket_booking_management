          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider">Send Mail<span class="panel-subtitle"></span></div>
                <div class="panel-body">
                  <form action="#" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                <textarea class="col-sm-6 control-label"></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                     <label class="col-sm-3 control-label"></label>
                      <div class="col-sm-6">
                    <button class="btn btn-rounded btn-space btn-primary"><i class="icon icon-left mdi mdi-cloud-done"></i> Send </button>
                    <button class="btn btn-rounded btn-space btn-primary"><i class="icon icon-left mdi mdi-cloud-done"></i> cancel</button>
                  </form>
                </div>
              </div>
            </div>
