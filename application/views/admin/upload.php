...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="dash/assets/lib/jquery.vectormap/jquery-jvectormap-1.2.2.css"/>
    <link rel="stylesheet" type="text/css" href="dash/assets/lib/jqvmap/jqvmap.min.css"/>
    <link rel="stylesheet" type="text/css" href="assets/lib/datetimepicker/css/bootstrap-datetimepicker.min.css"/>
    <link rel="stylesheet" href="dash/assets/css/style.css" type="text/css"/>
  </head>
  <body>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                  <form action="#" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <select class="form-control">
                          ...
                          <option>Airik Airline</option>
                          <option>Emirate Airline</option>
                          <option>Airpeace Airline</option>
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Flight class</label>
                      <div class="col-sm-6">
                        <select class="form-control">
                        <option>choose</option>
                    ...
                    <div class="form-group">
                     <label class="col-sm-3 control-label"></label>
                      <div class="col-sm-6">
                    <button class="btn btn-rounded btn-space btn-primary"><i class="icon icon-left mdi mdi-cloud-done"></i> Upload</button>
                    <button class="btn btn-rounded btn-space btn-primary"><i class="icon icon-left mdi mdi-cloud-done"></i> Reset</button>
                  </form>
                </div>
              </div>
            </div>
    ...
    <script src="dash/assets/lib/jquery/jquery.min.js" type="text/javascript"></script>
    <script src="dash/assets/lib/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js" type="text/javascript"></script>
    <script src="dash/assets/js/main.js" type="text/javascript"></script>
    <script src="dash/assets/lib/bootstrap/dist/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="dash/assets/lib/jquery-flot/jquery.flot.js" type="text/javascript"></script>
    <script src="dash/assets/lib/jquery-flot/jquery.flot.pie.js" type="text/javascript"></script>
    <script src="dash/assets/lib/jquery-flot/jquery.flot.resize.js" type="text/javascript"></script>
    <script src="dash/assets/lib/jquery-flot/plugins/jquery.flot.orderBars.js" type="text/javascript"></script>
    <script src="dash/assets/lib/jquery-flot/plugins/curvedLines.js" type="text/javascript"></script>
    <script src="dash/assets/lib/jquery.sparkline/jquery.sparkline.min.js" type="text/javascript"></script>
    <script src="dash/assets/lib/countup/countUp.min.js" type="text/javascript"></script>
    <script src="dash/assets/lib/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
    <script src="dash/assets/lib/jqvmap/jquery.vmap.min.js" type="text/javascript"></script>
    <script src="dash/assets/lib/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
